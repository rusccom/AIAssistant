    ...
    <aside class="dashboard-sidebar">
        ...
        <nav class="sidebar-nav">
            <a href="/dashboard.html" class="nav-item" id="nav-dashboard">
                ...
                <span class="nav-text" data-i18n="app.sidebar.dashboard">Dashboard</span>
            </a>
            <a href="/bot-settings.html" class="nav-item" id="nav-bot-settings">
                ...
                <span class="nav-text" data-i18n="app.sidebar.botSettings">Bot Settings</span>
            </a>
        </nav>
        <div class="sidebar-footer">
            ...
            <a href="#" class="nav-item logout-item" id="logout-button">
                ...
                <span class="nav-text" data-i18n="app.sidebar.signOut">Sign Out</span>
            </a>
        </div>
    </aside>
`;
...
export const insertSidebar = () => {
    ...
    if (dashboardLayout) {
        ...
        refreshLocalizedUi(dashboardLayout);
...
const setupProfileModal = () => {
    ...
    form?.addEventListener('submit', async (e) => {
        ...
        if (newPassword !== confirmPassword) {
            errorDiv.textContent = t('app.password.mismatch');
        ...
        try {
            ...
            // Success
            closeModal();
            showSuccess(t('app.password.updated'));
...
const updateUserInfo = async () => {
    ...
    if (userNameEl) {
        userNameEl.textContent = user.firstName ? `${user.firstName} ${user.lastName}` : t('app.user.defaultName');
    }
    if (userEmailEl) {
